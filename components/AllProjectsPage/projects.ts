...
export const projects = [
  {
    ...
    result:
      "award-winning project, connected with ecological charity, currently ran a successful NFT sale and staking, game demo coming soon",
    links: ["https://pixelseal.io/", "https://twitter.com/PixelSealNFT"],
    inputs:
      "existing marketing and design team from customer side with their own plans and schedule, unstable investment processes.",
    solutions: [
  ...
  },
  {
    ...
    result:
      "really successful project with large community, currently finished few NFT sales on own marketplace with different properties, everything is connected with game metaverse",
    links: [
      "https://bithotel.io/",
    ...
    inputs:
      "lots of teams working on different aspects of project at the same time, complicated technical specification, limited time span",
    solutions: [
  ...
  },
  {
    name: "MineBarons",
    desc:
      "Custom web development / GameFi /  NFT / Marketplace / DAO / Tokenomics ",
    project:
      "GameFi project in medieval setting with various NFT collections, staking, RPG elements and DAO on Polygon blockchain",
    result:
      "demo stage with tokenomics, staking and NFT lands; next stage - launching DAO and collection",
    links: [
